...
// connection-string constructor option). Swapping to hosted Postgres later
// means swapping this adapter for `@prisma/adapter-pg` (or similar) — the
// rest of the app only ever imports `prisma` from this file.
